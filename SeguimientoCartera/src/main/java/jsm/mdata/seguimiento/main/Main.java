...
public class Main
{
	...
	private static void generacionInformeHtml(Connection connection) throws Throwable
	{
		...
		templateDto.setChartTipoActivoBGColor(HtmlTemplate.getChartBGColor(vistaTipoActivo));
		...
		templateDto.setChartOroBGColor(HtmlTemplate.getChartBGColor(vistaSubtipoActivoOro));
		...
		templateDto.setChartRentaFijaBGColor(HtmlTemplate.getChartBGColor(vistaSubtipoActivoRF));
		...
		templateDto.setChartRentaVariableBGColor(HtmlTemplate.getChartBGColor(vistaSubtipoActivoRV));
		...
		templateDto.setChartMonedaBGColor(HtmlTemplate.getChartBGColor(vistaMoneda));
		...
		templateDto.setChartInstrumentoBGColor(HtmlTemplate.getChartBGColor(vistaInstrumento));
		...
		templateDto.setChartUsoIngresosBGColor(HtmlTemplate.getChartBGColor(vistaUsoIngresos));
		...
		templateDto.setChartMercadoBGColor(HtmlTemplate.getChartBGColor(vistaMercado));
		...
		templateDto.setChartComercializadorBGColor(HtmlTemplate.getChartBGColor(vistaComercializador));
		...
		templateDto.setChartProveedorBGColor(HtmlTemplate.getChartBGColor(vistaProveedor));
