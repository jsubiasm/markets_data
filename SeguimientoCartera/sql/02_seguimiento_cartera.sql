...
DROP VIEW VWF_SUBTIPO_ACTIVO_TOTAL;
...
--
--
CREATE VIEW VW02_GAN_PER_PROD_TOTAL AS 
SELECT
	PRODUCTO_ID, 
	NOMBRE, 
	COMERCIALIZADOR, 
...
--
--
CREATE VIEW VW03_GAN_PER_PROD_PESO_TOTAL AS 
SELECT
	PRODUCTO_ID, 
	NOMBRE, 
	COMERCIALIZADOR, 
...
FROM (
	...
	FROM VW02_GAN_PER_PROD_TOTAL
	CROSS JOIN (
		SELECT SUM(VALOR_TITULOS_ACTUALES) AS SUM_VALOR_TITULOS_ACTUALES FROM VW02_GAN_PER_PROD_TOTAL
	) 
...
FROM VW03_GAN_PER_PROD_PESO_TOTAL
ORDER BY 7, 8;
--
--
--
...
--
--
CREATE VIEW VWF_SUBTIPO_ACTIVO_TOTAL AS 	
SELECT 
	SUBTIPO_ACTIVO AS "Subtipo Activo",
	CAST(PRECIO_TITULOS_COMPRADOS AS DECIMAL(10, 2)) AS "Prec. Tit. C.", 
	CAST(PRECIO_TITULOS_VENDIDOS AS DECIMAL(10, 2)) AS "Prec. Tit. V.", 
