...
DROP VIEW VWF_GAN_PER_PROD_PESO_SUM;
...
SELECT
	...
	GANANCIA_PERDIDA,
	CAST((GANANCIA_PERDIDA * CAST(100 AS DECIMAL(31, 4)) / PRECIO_TITULOS_COMPRADOS) AS DECIMAL(31, 4)) AS GANANCIA_PERDIDA_PRCNT
FROM (
	SELECT
		PRODUCTO_ID, 
		NOMBRE, 
		...
		VALOR_TITULO, 
		VALOR_TITULOS_ACTUALES,
		CAST((PRECIO_TITULOS_VENDIDOS + VALOR_TITULOS_ACTUALES - PRECIO_TITULOS_COMPRADOS) AS DECIMAL(31, 4)) AS GANANCIA_PERDIDA 
	FROM (
		SELECT 
			PRODUCTO_ID, 
			NOMBRE, 
			...
			TITULOS_ACTUALES, 
			VALOR_TITULO, 
			CAST((TITULOS_ACTUALES * VALOR_TITULO) AS DECIMAL(31, 4)) AS VALOR_TITULOS_ACTUALES 
		FROM (
			SELECT 
				...
				CAST((TMP_TITULOS_ACTUALES.TITULOS_COMPRADOS - TMP_TITULOS_ACTUALES.TITULOS_VENDIDOS) AS DECIMAL(31, 4)) AS TITULOS_ACTUALES, 
			...
			FROM (
				SELECT 
					...
					(CASE WHEN TMP_VENTAS.TITULOS_VENDIDOS IS NULL THEN CAST(0 AS DECIMAL(31, 4)) ELSE TMP_VENTAS.TITULOS_VENDIDOS END) AS TITULOS_VENDIDOS,
					(CASE WHEN TMP_VENTAS.PRECIO_TITULOS_VENDIDOS IS NULL THEN CAST(0 AS DECIMAL(31, 4)) ELSE TMP_VENTAS.PRECIO_TITULOS_VENDIDOS END) AS PRECIO_TITULOS_VENDIDOS
				FROM (
					SELECT 
						PRODUCTO_ID, 
						NOMBRE, 
...
SELECT
	...
	CAST((VALOR_TITULOS_ACTUALES * CAST(100 AS DECIMAL(31, 4)) / SUM_VALOR_TITULOS_ACTUALES) AS DECIMAL(31, 4)) AS PESO_EN_CARTERA
FROM (
	SELECT 
		PRODUCTO_ID, 
		NOMBRE, 
...
SELECT
	...
	MONEDA, 
	USO_INGRESOS,		
	CAST(TITULOS_COMPRADOS AS DECIMAL(31, 2)) AS TITULOS_COMPRADOS, 
	CAST(PRECIO_TITULOS_COMPRADOS AS DECIMAL(31, 2)) AS PRECIO_TITULOS_COMPRADOS, 
	CAST(TITULOS_VENDIDOS AS DECIMAL(31, 2)) AS TITULOS_VENDIDOS, 
	CAST(PRECIO_TITULOS_VENDIDOS AS DECIMAL(31, 2)) AS PRECIO_TITULOS_VENDIDOS, 
	CAST(TITULOS_ACTUALES AS DECIMAL(31, 2)) AS TITULOS_ACTUALES, 
	CAST(VALOR_TITULO AS DECIMAL(31, 2)) AS VALOR_TITULO, 
	CAST(VALOR_TITULOS_ACTUALES AS DECIMAL(31, 2)) AS VALOR_TITULOS_ACTUALES,
	...
	(CASE WHEN CAST(PESO_EN_CARTERA AS DECIMAL(31, 2)) >= 99.99 THEN 100 ELSE CAST(PESO_EN_CARTERA AS DECIMAL(31, 2)) END) AS PESO_EN_CARTERA
FROM VW03_GAN_PER_PROD_PESO 
WHERE PESO_EN_CARTERA > 0;
--
--
--
CREATE VIEW VWF_GAN_PER_PROD_PESO_SUM AS 	
SELECT 
	CAST(PRECIO_TITULOS_COMPRADOS AS DECIMAL(31, 2)) AS PRECIO_TITULOS_COMPRADOS, 
	CAST(PRECIO_TITULOS_VENDIDOS AS DECIMAL(31, 2)) AS PRECIO_TITULOS_VENDIDOS, 
	CAST(VALOR_TITULOS_ACTUALES AS DECIMAL(31, 2)) AS VALOR_TITULOS_ACTUALES, 
	CAST(GANANCIA_PERDIDA AS DECIMAL(31, 2)) AS GANANCIA_PERDIDA, 
	CAST((GANANCIA_PERDIDA * CAST(100 AS DECIMAL(31, 4)) / PRECIO_TITULOS_COMPRADOS) AS DECIMAL(31, 2)) AS GANANCIA_PERDIDA_PRCNT, 
	(CASE WHEN CAST(PESO_EN_CARTERA AS DECIMAL(31, 2)) >= 99.99 THEN 100 ELSE CAST(PESO_EN_CARTERA AS DECIMAL(31, 2)) END) AS PESO_EN_CARTERA 
FROM (
	SELECT  
