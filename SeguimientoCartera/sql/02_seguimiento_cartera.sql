...
--
--
DROP VIEW VW01_GAN_PERD_POR_PROD;
...
--
--
CREATE VIEW VW01_GAN_PERD_POR_PROD AS 
SELECT
	PRODUCTO_ID, 
	NOMBRE, 
	TITULOS_COMPRADOS, 
		...
		FROM (
			...
			FROM (
				...
				FROM (
					...
					TMP_MOVIMIENTO_PRODUCTO_COMPRA
...
ORDER BY TMP_GANANCIA_PERDIDA_PRCNT.NOMBRE;
--
--
--
COMMIT;
