...
ORDER BY TIPO_ACTIVO, SUBTIPO_ACTIVO, NOMBRE;
--
--
--
CREATE VIEW VWF_GAN_PER_PROD_PESO_TOTALES AS 	
SELECT 
	CAST(PRECIO_TITULOS_COMPRADOS AS DECIMAL(12, 2)) AS PRECIO_TITULOS_COMPRADOS, 
	CAST(PRECIO_TITULOS_VENDIDOS AS DECIMAL(12, 2)) AS PRECIO_TITULOS_VENDIDOS, 
	CAST(FLUJO_CAJA AS DECIMAL(12, 2)) AS FLUJO_CAJA, 
	CAST(VALOR_TITULOS_ACTUALES AS DECIMAL(12, 2)) AS VALOR_TITULOS_ACTUALES, 
	CAST(GANANCIA_PERDIDA AS DECIMAL(12, 2)) AS GANANCIA_PERDIDA, 
	CAST((GANANCIA_PERDIDA * CAST(100 AS DECIMAL(12, 4)) / PRECIO_TITULOS_COMPRADOS) AS DECIMAL(12, 2)) AS GANANCIA_PERDIDA_PRCNT, 
	(CASE WHEN CAST(PESO_EN_CARTERA AS DECIMAL(12, 2)) >= 99.99 THEN 100 ELSE CAST(PESO_EN_CARTERA AS DECIMAL(12, 2)) END) AS PESO_EN_CARTERA 
FROM (
	SELECT  
