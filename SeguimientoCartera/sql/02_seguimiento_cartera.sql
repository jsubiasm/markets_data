...
--
--
DROP VIEW VW01_MOVIMIENTO_PRODUCTO;
...
--
--
CREATE VIEW VW01_MOVIMIENTO_PRODUCTO AS 
	SELECT 
		MOV.MOVIMIENTO_ID, 
		MOV.PRODUCTO_ID, 
		PROD.NOMBRE, 
		...
		MOV.MERCADO
	FROM
		TB02_MOVIMIENTOS MOV INNER JOIN TB02_PRODUCTOS PROD ON MOV.PRODUCTO_ID = PROD.IDENTIFICADOR;
--
--
--
COMMIT;
