...
SELECT
	...
	MONEDA, 
	USO_INGRESOS,		
	CAST(TITULOS_COMPRADOS AS DECIMAL(12, 2)) AS TITULOS_COMPRADOS, 
	CAST(PRECIO_TITULOS_COMPRADOS AS DECIMAL(12, 2)) AS PRECIO_TITULOS_COMPRADOS, 
	CAST(TITULOS_VENDIDOS AS DECIMAL(12, 2)) AS TITULOS_VENDIDOS, 
	CAST(PRECIO_TITULOS_VENDIDOS AS DECIMAL(12, 2)) AS PRECIO_TITULOS_VENDIDOS, 
	CAST(TITULOS_ACTUALES AS DECIMAL(12, 2)) AS TITULOS_ACTUALES, 
	CAST(VALOR_TITULO AS DECIMAL(12, 2)) AS VALOR_TITULO, 
	...
	CAST(GANANCIA_PERDIDA_PRCNT AS DECIMAL(12, 2)) AS GANANCIA_PERDIDA_PRCNT,
