	...
	protected static void procesarElemento(WebDriver driver, String hrefElemento, String downloadPath, String timeFrame, Double minDividendo, Double minCapitalizacion) throws Exception
	{
		...
		for (WebElement reportTable : reportTableList)
		{
			...
			for (WebElement datoReport : datosReportList)
			{
				...
				// else if (celdaDatoList.size() > 1 && celdaDatoList.get(0).getAttribute("innerHTML") != null && celdaDatoList.get(0).getAttribute("innerHTML").indexOf(">BPA Básico <i class=\"lighterGrayFont arial_11\">ANN<") != -1)
				// {
				...
				// else if (celdaDatoList.size() > 1 && celdaDatoList.get(0).getAttribute("innerHTML") != null && celdaDatoList.get(0).getAttribute("innerHTML").indexOf(">Rotación de Activos <i class=\"lighterGrayFont arial_11\">TTM<") != -1)
				// {
				...
				// }
				// else if (celdaDatoList.size() > 1 && celdaDatoList.get(0).getAttribute("innerHTML") != null && celdaDatoList.get(0).getAttribute("innerHTML").indexOf(">Rotación de Inventarios <i class=\"lighterGrayFont arial_11\">TTM<") != -1)
				// {
				...
				// }
				// else if (celdaDatoList.size() > 1 && celdaDatoList.get(0).getAttribute("innerHTML") != null && celdaDatoList.get(0).getAttribute("innerHTML").indexOf(">Rotación de Cuentas a Cobrar <i class=\"lighterGrayFont arial_11\">TTM<") != -1)
				// {
