...
public class DriverControllerLST extends DriverControllerBase
{
	...
	static
	{
		...
		listaURL_09.add("https://es.investing.com/equities/mrs");
		...
		listaURL_09.add("https://es.investing.com/equities/u.s.-bancorp-pa-adr");
		...
		for (URLGroup urlGroup : LISTA_URL_GROUP)
		{
			...
			while (urlsIdx < listaURL.size())
			{
				try
				{
					...
					procesarElemento(driver, hrefElemento, DOWNLOAD_PATH + "\\" + downloadFolder + "\\" + TF_MENSUAL, TF_MENSUAL, RPD_MINIMA, CAP_MINIMA);
