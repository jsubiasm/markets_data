...
public class DriverController
{
	...
	static
	{
		...
		LISTA_URLS.add("https://es.investing.com/etfs/db-x-trackers-muni-infras-revn");
		...
		LISTA_URLS.add("https://es.investing.com/etfs/egshares-india-infrastructure");
		LISTA_URLS.add("https://es.investing.com/etfs/etfs-physical-swiss-gold-shares");
		LISTA_URLS.add("https://es.investing.com/etfs/etracs-1xmon.-sh.-al.-mlp-infr.-tr");
		LISTA_URLS.add("https://es.investing.com/etfs/etracs-alerian-mlp-infrastructure");
		...
		LISTA_URLS.add("https://es.investing.com/etfs/flexshares-stoxx-gbl-brd-infrs");
