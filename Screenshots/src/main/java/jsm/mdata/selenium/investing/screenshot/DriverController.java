...
public class DriverController
{
	...
	static
	{
		...
		LISTA_URLS.add("https://es.investing.com/etfs/direxion-daily-emerging-markets-bea");
		LISTA_URLS.add("https://es.investing.com/etfs/direxion-daily-emerging-markets-bul");
