 ...
 *
 */
public class DCWebUrlFromNombreEmpresa_v2 extends DriverControllerBase
{

	/**
	 * Logger
	 */
	private final static Logger LOGGER = LoggerFactory.getLogger(DCWebUrlFromNombreEmpresa_v2.class);
