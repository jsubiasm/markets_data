 ...
 *
 */
public class DCWebUrlFromNombreEmpresa_Yahoo
{

	/**
	 * Logger
	 */
	private final static Logger LOGGER = LoggerFactory.getLogger(DCWebUrlFromNombreEmpresa_Yahoo.class);
	 ...
	 * 
	 */
	private final static String URL_INICIAL = "https://es.search.yahoo.com/search?p=";
			...
			for (URLGroup empresasGroup : LISTA_EMPRESAS_GROUP)
			{
				...
				while (empresaIdx < listaEmpresas.size())
				{
					...
					try
					{
						...
						WebElement divMain = driver.findElement(By.id("main"));
						List<WebElement> listaLinks = divMain.findElements(By.tagName("a"));
